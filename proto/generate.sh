...
GO_MODULE="github.com/kamalyes/kronos-cluster"
...
if grep -q "google.api.http" proto/distributed.proto 2>/dev/null; then
...
if grep -q "openapiv2_swagger" proto/distributed.proto 2>/dev/null; then
    echo "📖 生成 OpenAPI 文档..."
    protoc -I"$PROTOC_INCLUDE" $GOOGLEAPIS_PATH $GRPC_GATEWAY_PATH -I. \
        --openapiv2_out=. \
